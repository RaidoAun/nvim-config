...
-- "#16161e"
-- "#0C0E14"
vim.api.nvim_set_hl(0, "NeogitDiffAdd", { bg = "#18291B", fg = "#51CF59", bold = false })
vim.api.nvim_set_hl(0, "NeogitDiffDelete", { bg = "#291818", fg = "#CF5151", bold = false })
vim.api.nvim_set_hl(0, "NeogitDiffAddHighlight", { bg = "#18291B", bold = false })
vim.api.nvim_set_hl(0, "NeogitDiffDeleteHighlight", { bg = "#291818", bold = false })
vim.api.nvim_set_hl(0, "NeogitDiffAddInline", { fg = "#51FF59", bold = true })
vim.api.nvim_set_hl(0, "NeogitDiffDeleteInline", { fg = "#FF5151", bold = true })
